...
function readStore() {
  ...
  try {
    ...
    // Ensure all seeded projects are always present in the store
        ...
        nodes: [
          {
            ...
            data: {
              title: "수동 회의 기록의 한계",
              content: "회의 중 실시간으로 오가는 수많은 생각과 의사결정을 수동으로 받아적는 과정에서 중요한 맥락이 유실되고, 회의 집중도가 저하됨.",
              category: "Why",
              phase: "Idea",
              sourceType: "user",
              visibility: "agreed",
          ...
          },
          {
            ...
            position: { x: 500, y: 150 },
            data: {
              title: "실시간 노드 기반 회의록 서비스",
              content: "음성을 실시간으로 텍스트로 변환하고, 인공지능이 논의 맥락을 분석하여 핵심 아젠다와 인과 관계를 시각적인 노드 맵으로 실시간 구성해주는 서비스.",
              category: "What",
              phase: "Idea",
              sourceType: "agent",
              visibility: "agreed",
          ...
          },
          {
            ...
            position: { x: 500, y: 400 },
            data: {
              title: "Whisper 및 GPT-4o 실시간 파이프라인",
              content: "웹 브라우저 오디오 스트림을 WebSockets를 통해 백엔드로 전송하고, Whisper Live API로 변환 후 GPT-4o로 구조화된 노드 데이터 생성.",
              category: "How",
              phase: "Solution",
              sourceType: "mixed",
              visibility: "shared",
          ...
          },
          {
            ...
            data: {
              title: "역할 분담 및 마일스톤",
              content: "Hyeonji님이 전체 기획 및 UX 설계를, Sooyun님과 Jimin님이 AI 파이프라인 및 백엔드 개발을, Taeeun님이 ReactFlow 기반의 캔버스 UI를 담당함.",
              category: "Who",
              phase: "Action",
              sourceType: "user",
              visibility: "agreed",
