        ...
        nodes: [
          {
            ...
            style: { width: 590, height: 260, background: "transparent", border: "none", zIndex: 0 },
          },
          {
          ...
          },
          {
            ...
            data: {
              ...
              content: "저희가 회의를 할 때도 새 아이디어가 생각나지만, 회의가 끝난 후에도 생각이 새록새록 나잖아요? 이런 경우에는 다음 회의 때 아이디어를 공유하게 되는데, 그럼 경우 각자의 생각 맥락 때문에 정확하게 이해시키기가 어렵더라고요. 따로 있더라도 생각 맥락을 공유하는 기능이 있으면 좋지 않을까요?",
