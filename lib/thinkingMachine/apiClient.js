...
import {
  ...
  leaveAllOtherMembers as browserLeaveAllOtherMembers,
  restoreOriginalMembers as browserRestoreOriginalMembers,
...
export async function leaveAllOtherMembers(projectId, keepUserId) {
  if (typeof window !== "undefined") {
    return browserLeaveAllOtherMembers(projectId, keepUserId);
  }
  return [];
}

export async function restoreOriginalMembers(projectId) {
  if (typeof window !== "undefined") {
    return browserRestoreOriginalMembers(projectId);
  }
  return [];
}
